      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-gray-300 space-y-6 leading-8 text-lg">
          ...
          <div className="relative rounded-2xl overflow-hidden my-8">
            <img src="https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=1200&auto=format&fit=crop" alt="Mobile App" className="w-full h-80 object-cover" />
          ...
          <div className="relative rounded-2xl overflow-hidden my-8">
            <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?q=80&w=1200&auto=format&fit=crop" alt="Swipe Feed" className="w-full h-80 object-cover" />
          ...
          <div className="relative rounded-2xl overflow-hidden my-8">
            <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=1200&auto=format&fit=crop" alt="Learning" className="w-full h-80 object-cover" />
          ...
          <div className="relative rounded-2xl overflow-hidden my-8">
            <img src="https://images.unsplash.com/photo-1563013544-824ae1b704d3?q=80&w=1200&auto=format&fit=crop" alt="Marketplace" className="w-full h-80 object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
